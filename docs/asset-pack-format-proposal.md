...
Status: Accepted and implemented for format 0.3; E7B content human-approved
Updated: 2026-07-19
...
Implementation checkpoint: the generic rules below are implemented. References to a “future implementation” preserve the accepted design history. Anthony McClure approved the exact E7B candidate, which is publicly valid and installable; see [the review package](reviews/amateur-extra-e7b-asset-content-review.md).
