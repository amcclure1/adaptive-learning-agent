...
Proposed ADR 0021 adds mandatory independent AI verification before human approval. The repeat experiment preserved the original 14-source/30-claim workspace as baseline A and created a separate baseline B. Baseline B did not improve first-pass quality (9 findings versus 7) but the fail-closed process contained 21 logical defects through three revision cycles. Its final current set is 17 sources and 30 claims, all independently verified with zero residual finding. All human decisions remain pending and compilation eligibility is false. Projection targets existing format 0.2 by default; internal verification/review records remain outside learner packs and SQLite. No lesson, learner-ready question, approval, candidate pack, installation, activation, publication, release, or tag exists. See the [comparison](experiments/sap-org-04-comparison.md) and [repeat-experiment handoff](handoffs/sap-org-04-repeat-experiment.md).
