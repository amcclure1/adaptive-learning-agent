...
Format 0.3, PNG validation/digesting, logical references, additive contract responses, and the fallback-first skill are implemented. Anthony McClure approved the exact E7B10–E7B12/E7-1 candidate, which is now valid and installable. The offline lifecycle and Python 3.12–3.14 matrix pass. Hosted CI, coverage diagnostics, and complete real Hermes E7B presentation remain before release readiness; the existing profile learner's unrelated active E1A session currently prevents the E7B presentation check. 0.2B still excludes generated questions, curriculum planning, subject building, capability discovery, MCP, AWS, new scoring, and SQLite changes. See [the review package](reviews/amateur-extra-e7b-asset-content-review.md) and [release-readiness handoff](handoffs/amateur-extra-asset-0.2b-release-readiness.md).
